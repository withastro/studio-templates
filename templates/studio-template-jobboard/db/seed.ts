...
await db.insert(JobPosting).values([
	{
	    ...
	    <p>
	      ...
	      more.
			...
			<p>
				You will be responsible for creating the content strategy and writing
				for the Astro website, documentation, and other marketing materials.
			</p>
	    `,
	},
	{
	...
	},
	{
		...
		richText: `<h2>About the role</h2>
			...
			<small>BTW, this was totally not generated by a AI; sorry not sorry. Greetz, Elian</small>
			`,
	},
]);
